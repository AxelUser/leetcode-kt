...
import problems.utils.parseIntMatrix
...
internal class SearchA2DMatrixTest {
    ...
    companion object {
        @JvmStatic
        fun args() = listOf(
            Arguments.of(parseIntMatrix("[[1,3,5,7],[10,11,16,20],[23,30,34,60]]"), 3, true),
            Arguments.of(parseIntMatrix("[[1,3,5,7],[10,11,16,20],[23,30,34,60]]"), 13, false),
        )
    }
}